...
(*                    0.    1.     2.       3
1       u256_pack4 st.[1]  st.[2]  st.[3]  st.[4];
2       u256_pack4 st.[10] st.[20] st.[5]  st.[15];
3       u256_pack4 st.[16] st.[7]  st.[23] st.[14];
4       u256_pack4 st.[11] st.[22] st.[8]  st.[19];
5       u256_pack4 st.[21] st.[17] st.[13] st.[9];
6       u256_pack4 st.[6]  st.[12] st.[18] st.[24]].
*)
print stavx2_from_st25.
op stavx2_pos n =
