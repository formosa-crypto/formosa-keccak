...
*)
(* NOTE: the [test_keccakf1600x4_native] proc is no longer generated by the
   extraction (parameter-based selection refactor), so the (admitted) lemma
   below is commented out until an equivalent test harness is reinstated.
...
lemma keccakf1600_avx2x4_native_ll: islossless M.__keccakf1600_avx2x4_nat.
proof.
proc.
