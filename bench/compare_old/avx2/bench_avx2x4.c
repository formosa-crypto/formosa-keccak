...
int run_bench(uint64_t rate8, uint64_t trail, uint64_t size, uint64_t bigsize) {
    ...
    uint64_t cycles_init[RUNS], cycles_absorb[RUNS], cycles_squeeze[RUNS], cycles_absorb_bcast[RUNS];
    uint8_t * _p_st;
    ...
    printf("|     init_state_avx2x4    |     absorb_avx2x4     |     squeeze_avx2x4    |     absorb_bcast_avx2x4    |\n");
    printf("|------------------------|------------------------|------------------------|--------------------------|\n");
